public class Lattice {
	...
	public Lattice() {
		...
		for (int x=0; x<WIDTH; x++) {
			for (int y=0; y<HEIGHT; y++) {
				// Zu jedem Knoten geh�rt ein Gewichtsvektor, bei RGB-Daten der Dimension 3
	...
	public Node getBMU(MyVector inputVector) {
		...
		// gem�� Abstand vom inputVector zum Matrix-Vektor (Euklidische Distanz)
		for (int x=0; x<WIDTH; x++) {
			for (int y=0; y<HEIGHT; y++) {
